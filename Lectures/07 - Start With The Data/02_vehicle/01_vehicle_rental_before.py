...
def read_vehicle_type(vehicle_types: set[str]) -> str:
...
def main():
    ...
    vehicle_type = read_vehicle_type(set(VEHICLES.keys()))
    days = read_rent_days()
    ...
    print(rental)
    rental_price = rental.vehicle.total_price(days, additional_km)
